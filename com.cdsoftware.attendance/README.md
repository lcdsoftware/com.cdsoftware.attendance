...
- New callout
    ...
    * Example: com.cdsoftware.lirion.attendance.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.cdsoftware.lirion.attendance.process
    * Example: com.cdsoftware.lirion.attendance.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.cdsoftware.lirion.attendance.form
    * Example: com.cdsoftware.lirion.attendance.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.cdsoftware.lirion.attendance.event
    * Example: com.cdsoftware.lirion.attendance.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.cdsoftware.lirion.attendance.model
    * Example: com.cdsoftware.lirion.attendance.model.MTableExample
...
```
    com.cdsoftware.lirion.attendance
        ...
        |   |_ProcessFactory.xml
        |_src
            |_com.cdsoftware.lirion.attendance
                |_base (plugin core)
...
- New callout
    * Create callout in package `com.cdsoftware.lirion.attendance.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `com.cdsoftware.lirion.attendance.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `com.cdsoftware.lirion.attendance.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `com.cdsoftware.lirion.attendance.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `com.cdsoftware.lirion.attendance.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
