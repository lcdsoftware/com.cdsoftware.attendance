...
public class ProcessAttendanceBioadmin extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		/*StringBuilder sql = new StringBuilder ("DELETE HR_Attribute ")
		...
		*/
		...
		for(MHR_AttendanceLine attendanceline : list_attendanceline) {
			...
			log.warning("Antes del ciclo diferencia "+String.valueOf(diff)+" restDays "+String.valueOf(restDays)+" Nonbusinessdays "+String.valueOf(nonBusinessDays)+" i "+String.valueOf(i));
		...
		log.warning("Despues del ciclo diferencia "+String.valueOf(diff)+" restDays "+String.valueOf(restDays)+" Nonbusinessdays "+String.valueOf(nonBusinessDays)+" i "+String.valueOf(i));
