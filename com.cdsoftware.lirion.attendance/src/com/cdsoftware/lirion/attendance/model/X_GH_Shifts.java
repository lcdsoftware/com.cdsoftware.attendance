...
public class X_GH_Shifts extends PO implements I_GH_Shifts, I_Persistent 
{
    ...
    public X_GH_Shifts (Properties ctx, int GH_Shifts_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_GH_Shifts (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_GH_Shifts[")
	...
	/** Set GH_Shifts_UU.
		@param GH_Shifts_UU GH_Shifts_UU	  */
	public void setGH_Shifts_UU (String GH_Shifts_UU)
	{
		set_ValueNoCheck (COLUMNNAME_GH_Shifts_UU, GH_Shifts_UU);
	}

	/** Get GH_Shifts_UU.
		@return GH_Shifts_UU	  */
	public String getGH_Shifts_UU () 
	{
		return (String)get_Value(COLUMNNAME_GH_Shifts_UU);
	}
