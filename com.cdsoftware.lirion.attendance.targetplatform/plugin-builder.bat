...
call mvn validate -Didempiere.target=com.cdsoftware.lirion.attendance.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.cdsoftware.lirion.attendance.p2.targetplatform %DEBUG_MODE%
